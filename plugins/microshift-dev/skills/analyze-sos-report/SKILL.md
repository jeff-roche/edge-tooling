---
name: microshift-dev:analyze-sos-report
...
- Second argument (log.html-url): URL to Robot Framework log.html file - **Optional**
...
1. Fetch and parse the log.html file using WebFetch

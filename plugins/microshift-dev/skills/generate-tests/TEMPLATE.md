...
The pre-configured `/microshift-dev:generate-tests` command is optimized for MicroShift/OpenShift projects with specific assumptions about:
...
### Test Case Generation (CUSTOMIZE THIS)
